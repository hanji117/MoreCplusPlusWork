...
#include <iostream>
//prototypes
void createLL(LL& ll, string s);
bool palindrome(LL& ll);
int main()
{
  LL myLL;
  string sentence;
...
bool palindrome(LL& ll)// string s) different length because we got rid of spaces and punctuations. Different length.
{
  char ch, ch2;
